...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ab7m7w8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ab7m7w8.containers.anotherwebservice.com/
...
```
git clone git@github.com:Georgio69420/container-ab7m7w8.git
cd container-ab7m7w8
```
...
```
docker attach container-ab7m7w8
```
